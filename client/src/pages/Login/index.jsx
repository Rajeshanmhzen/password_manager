        ...
        <Card className="w-full max-w-sm">
          <CardHeader>
            <CardTitle className="text-center">
              {showOTP ? "Two-Factor Authentication" : "Login to Account"}
            </CardTitle>
          </CardHeader>
          <CardContent>
            {showOTP ? (
              <form onSubmit={handleOTP}>
                <div className="flex flex-col gap-6 justify-center items-center text-center">
                  ...
                  <p className="text-sm">
                    We have sent a verification code to your email <span className="underline">{email}</span>
                  </p>
                  <InputOTP
                    maxLength={6}
                    value={formData}
                  ...
                  <Button
                    ...
                    className="w-full"
                  >
                    {isLoading ? <Spinner variant="ellipsis" /> : "Verify"}
                  </Button>
                </div>
              </form>
            ) : (
                      ...
                      <Dialog>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            ...
                            <DialogDescription>
                              <p className="my-4">
                                We don't store your password, we only have its
                                encrypted hash.
                              </p>
                              <p>
                                Therefore, we unfortunately cannot recover or send
                                it back. If you forgot your password, please
